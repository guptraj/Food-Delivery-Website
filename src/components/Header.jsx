          ...
          <div className="relative">
            ...
            {isMenu && (
              <motion.div
                ...
                className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-19 right-0"
              >
                {user && user.email === "guptraj15@gmail.com" && (
                  <Link to="/createItem">
                    <p
          ...
          {isMenu && (
            ...
            >
              ...
              <ul className="flex flex-col">
                <li
                  className="text-lg text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer hover:bg-slate-100 px-4 py-2"
                  onClick={() => setIsMenu(false)}
                >
                  Home
                </li>
